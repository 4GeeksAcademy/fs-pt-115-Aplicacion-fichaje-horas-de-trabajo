...
export const Profile = () => {
  ...
  // subir documento (contrato o nómina)
      ...
      <div className="row g-4 mt-1 d-flex justify-content-center">
        <div className="col-lg-4">
          ...
          <div className="container my-4 text-center">
            ...
            <div className="card mb-4 p-3 bg-dark text-white border border">
              <h6 className="fw-bold mb-3">Contracts</h6>
              {store.userContracts.length ? (
                store.userContracts.map(c => (
                  <div
                    key={c.id}
                    className="p-3 mb-3 bg-secondary rounded d-flex justify-content-between align-items-center flex-wrap gap-2"
                  >
                    <p className="mb-0 fw-semibold">Contrato de trabajo</p>
            ...
            <div className="card mb-4 p-3 bg-dark text-white border border">
              ...
              {store.payrolls.length ? (
                store.payrolls.map(p => {
                  const fecha = p.uploaded_at;
                  let mes = "N/A";
                  if (fecha) {
                    const f = new Date(fecha);
                    f.setMonth(f.getMonth() - 1);
                    mes = f.toLocaleString("default", { month: "long", year: "numeric" });
                  ...
                  return (
                    <div
                      ...
                      className="p-3 mb-3 bg-secondary rounded d-flex justify-content-between align-items-center flex-wrap gap-2"
                    >
                      <p className="mb-0 fw-semibold">Mes: {mes}</p>
                      <div className="d-flex align-items-center gap-2 flex-wrap">
                        {p.file_url && (
                          <a
                            href={p.file_url}
